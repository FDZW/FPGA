...
set_property -dict  {PACKAGE_PIN V20 IOSTANDARD LVCMOS33 IOB TRUE PULLTYPE PULLUP} [get_ports  spi_0_miso] ; ## JB2_P
set_property -dict  {PACKAGE_PIN W20 IOSTANDARD LVCMOS33 IOB TRUE}           [get_ports  spi_0_sclk] ; ## JB2_N
...
set_property -dict  {PACKAGE_PIN T11 IOSTANDARD LVCMOS33 IOB TRUE PULLTYPE PULLUP} [get_ports  spi_1_miso] ; ## JC2_P
set_property -dict  {PACKAGE_PIN T10 IOSTANDARD LVCMOS33 IOB TRUE}           [get_ports  spi_1_sclk] ; ## JC2_N
...
set_property -dict  {PACKAGE_PIN P14 IOSTANDARD LVCMOS33 IOB TRUE PULLTYPE PULLUP} [get_ports  spi_2_miso] ; ## JD2_P
set_property -dict  {PACKAGE_PIN R14 IOSTANDARD LVCMOS33 IOB TRUE}           [get_ports  spi_2_sclk] ; ## JD2_N
